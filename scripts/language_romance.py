    ...
    for index, directory in enumerate(directories):
      ...
      if len(target_languages) == 0 or directory in target_languages:
        ...
        for i, file in enumerate(files):
          ...
          data = process_file("../data_romance/" + directory + "/" + file)
...
def handle_data():
  ...
  with open("../data/dataset_romance.csv", 'w', newline='') as file:
    file.truncate(0)

  # Set column labels
  print("Inserting titles...")
  with open("../data/dataset_romance.csv", 'w') as file:
  ...
  for language in languages:
    print(language)
    language.write_to_csv(max_rows, "../data/dataset_romance.csv")
