...
def handle_data():
  ...
  with open("../data/dataset_languages.csv", 'w', newline='') as file:
    file.truncate(0)

  # Set column labels
  print("Inserting titles...")
  with open("../data/dataset_languages.csv", 'w') as file:
  ...
  for language in languages:
    print(language)
    language.write_to_csv(max_rows, "../data/dataset_languages.csv")
